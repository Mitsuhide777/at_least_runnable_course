...
// E.G. for debug:
//		System.err.println("SimpleClassLoader: className = "+name+"; classLoader  = "+this);
...
//----------------------------- E.G.--------------------------
/*
	public void printRawClasses()
	{
		System.err.println("------ rawClasses -------");
		for(Enumeration e = rawClasses.keys(); e.hasMoreElements();)
		{
			String name = (String)e.nextElement();
			Object value = rawClasses.get(name);
			System.err.println("    name = "+name+"; bytes = "+((byte [])value).length);
		}
		System.err.println("-------------------------");
	}

	public void printResourceHash()
	{
		System.err.println("------ ResourceHash -------");
		for(Enumeration e = resourceHash.keys(); e.hasMoreElements();)
		{
			String name = (String)e.nextElement();
			//Object value = resourceHash.get(name);
			//System.err.println("    name = "+name+"; bytes = "+((byte [])value).length);
	...
	public void printMimeHash()
	{
		System.err.println("---------- MimeHash -------");
		for(Enumeration e = mimeHash.keys(); e.hasMoreElements();)
		{
			String name = (String)e.nextElement();
			String type = (String)mimeHash.get(name);
