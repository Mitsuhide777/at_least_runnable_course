...
public class JarInfo 
{
     ...
     * @param	beanNames	The names for all the beans
		   ...
		   MessageHeader[] manifestData) 
	{
		...
		for (int i = 0; i < beanNames.length; i++) 
		{
			...
			// E.G. for debug:
			//System.err.println("calling Introspector:");
			//System.err.println("class = "+c.getName()+"; classLoader = "+c.getClassLoader());
...
// E.G.(17.05.2002):
/*
String[] spath = Introspector.getBeanInfoSearchPath();
if(spath != null)
{
	System.err.println("Introspector search path:");
	for(int ii = 0; ii < spath.length;++ii)
	{
		System.err.println("  ["+ii+"]: "+spath[ii]);
	}
}
else
{
	System.err.println("Introspector search path = null.");
}

if(bi != null)
{
	System.err.println(beanNames[i]+ " has "+bi.getPropertyDescriptors().length + "properties.");
}
//*/
...
//*/
    ...
    public Object getInstance(String name) 
	{
		...
		{
			// E.G.(03.09.2001):
			System.err.println("throwable in Beans.instantiate("+name+"): "+th.toString());
			//String thTypeName = th.getClass().getName();
			th.printStackTrace();
			// end E.G.
    ...
    void diagnoseInstantiationException(SimpleClassLoader cl, String beanName, Throwable realx) 
	{
		...
		catch (Throwable th) 
		{
			...
			{
				th.printStackTrace();// commented E.G.
			}
			return;
		}
		...
		System.err.println("    But an exception was generated in Beans.instantiate:");
		System.err.println("        " + realx);
		realx.printStackTrace();// commented E.G.
    }
