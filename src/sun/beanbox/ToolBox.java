...
class ToolBoxPanel extends Panel implements Runnable, MouseListener 
{
     ...
     */
	/*
	// commented by me (13.11.2001) E.G. // was not used at all...
    ...
    public void run() 
	{
		...
		for (;;) 
		{
			...
			synchronized (this) 
			{
				...
				bean = pendingBean;
				//beanLabel = pendingBeanLabel;//"@"+Integer.toHexString(bean.hashCode());
				beanLabel = pendingBeanLabel+"@"+Integer.toHexString(bean.hashCode());
    ...
    public void mousePressed(MouseEvent evt) 
	{
		...
		else 
		{
			...
			try 
			{
				...
				//for debug(E.G.):
				//String bean_type = bean.getClass().getName();
