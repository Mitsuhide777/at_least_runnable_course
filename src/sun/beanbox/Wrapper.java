				...
				MouseListener, MouseMotionListener 
{
    ...
    public Wrapper(Object bean, String beanLabel, String beanName) 
	{
		...
		{
			//beanLabel = beanName;
			beanLabel = beanName+"@"+Integer.toHexString(bean.hashCode());
		}
    ...
    synchronized void addEventTarget(
			String eventSetName,
	...
	{
		Enumeration en = eventTargets.elements();
		while (en.hasMoreElements())
		{
			WrapperEventTarget et = (WrapperEventTarget)en.nextElement();
    ...
    void writeNakedBean(ObjectOutputStream oos) 
		throws IOException 
	{
System.err.println(getClass().getName()+".writeNakedBean("+oos+") invoked.");
    ...
    //----------------------------------------------------------------------
	//E.G.(01.08.2000):
	public Object[] getAllParentsBeans()
	{
		...
		for(int i = 0; i < components.length; ++i)
		{
			...
			{
				Wrapper w = (Wrapper)components[i];
				Object b = w.getBean();
				tmp.addElement(b);
			}
		}
