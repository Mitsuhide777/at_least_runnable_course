...
import com.paragraph.grinkrug.beanbox.*;
...
public class HookupManager 
{
	...
	{
//debug:
Class ifs = esd.getListenerType();
System.err.println("hookup(): ifs ->"+ifs.getName());


		//--------------- My implementation (no compile) --------------------------
		/*/
System.err.println("hookup(...): esd = "+esd);
Method methods[] = esd.getListenerMethods();
for(int i = 0; i < methods.length; ++i)
{
	System.err.println("  esd.listenerMethod["+i+"] -> "+methods[i]);
}

System.err.println("hookup(...): listenerMethod = "+listenerMethod);
System.err.println("hookup(...): sourceBean = "+sourceWrapper.getBean());
System.err.println("hookup(...): targetBean = "+targetWrapper.getBean());
System.err.println("hookup(...): targetMethod = "+targetMethod);

			Object hookup = new DynamicHookup();
			Method setTargetMethod = findMethod(hookup.getClass(), "setTargetBean");   
			Object args[] = new Object[1];
			args[0] = targetWrapper.getBean();
			try
			{
			...
			{
				System.err.println("Exception while invoke(): "+e);
			}
System.err.println("hookup(...): calling addEventTarget("+esd.getName()+",...)...");
			sourceWrapper.addEventTarget(esd.getName(), targetWrapper, hookup);

		//*/
		//--------------- End of my implementation --------------------------------
		//*
		//--------------------- Sun BeanBox implementation ------------------------
		try 
		{
...
//System.err.println("hookupName = "+hookupName);
//System.err.println("source object class = "+source.getClass().getName());
//System.err.println("source object class loader = "+source.getClass().getClassLoader());
//System.err.println("target object class = "+target.getClass().getName());
//System.err.println("target object class loader = "+target.getClass().getClassLoader());
		...
		//---------------------- End of Sun BeanBox implementation -------------------
		//*/
    }
	//*/
...
//--------------- E.G. ----------------
//
//	tmpDir = System.getProperty("user.dir") + java.io.File.separatorChar + tmpDir;
//
//-------------------------------------
    }
	//*/
