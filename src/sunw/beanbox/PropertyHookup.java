...
import java.util.Enumeration;//E.G.
...
public class PropertyHookup implements PropertyChangeListener, Serializable 
{
	...
	{
//System.err.println(getClass().getName()+".propertyChange("+evt+").");

		String propertyName = evt.getPropertyName();
//System.err.println(getClass().getName()+".propertyChange("
//				   +evt
//				   +"): propertyName = "
//				   +propertyName);
//for(Enumeration e = targetsByPropertyName.keys(); e.hasMoreElements(); )
//{
...
//System.err.println("PropertyHookup: calling evt.getNewValue()...");
		Object args[] = { evt.getNewValue() };
//System.err.println("PropertyHookup: args[0].getClass() = "+args[0].getClass());
		for (int i = 0; i < targets.size(); i++) 
		{
			PropertyHookupTarget target = 
			...
			{
	 			System.err.println("Property set failed: "+ex);
				//ex.getTargetException().printStackTrace();
			}
			catch (Exception ex) 
			{
	 			System.err.println("Unexpected Property set exception: "+ex);
				System.err.println("target.setter = "+target.setter);
				System.err.println("    args[0] type = "+args[0].getClass().getName());
				//ex.printStackTrace();
			}
		}
    }
